...
func Load() (cfg *Config, err error) {
	...
	cfg = &Config{
		...
		JWTIssuer:                         getEnv("JWT_ISSUER", "everything-backend-starter-kit"),
		JWTAudience:                       getEnv("JWT_AUDIENCE", "everything-backend-starter-kit-api"),
		...
		OTELServiceName:          getEnv("OTEL_SERVICE_NAME", "everything-backend-starter-kit"),
