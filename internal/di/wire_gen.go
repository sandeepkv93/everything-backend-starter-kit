...
func InitializeApp() (*app.App, error) {
	...
	dependencies := provideRouterDependencies(authHandler, userHandler, adminHandler, jwtManager, rbacService, permissionResolver, globalRateLimiterFunc, authRateLimiterFunc, forgotRateLimiterFunc, idempotencyMiddlewareFactory, probeRunner, configConfig)
