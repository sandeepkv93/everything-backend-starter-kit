...
func InitializeApp() (*app.App, error) {
	...
	dependencies := provideRouterDependencies(authHandler, userHandler, adminHandler, jwtManager, rbacService, globalRateLimiterFunc, authRateLimiterFunc, idempotencyMiddlewareFactory, probeRunner, configConfig)
