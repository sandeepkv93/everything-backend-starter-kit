...
func InitializeApp() (*app.App, error) {
	...
	dependencies := provideRouterDependencies(authHandler, userHandler, adminHandler, featureFlagHandler, jwtManager, rbacService, permissionResolver, globalRateLimiterFunc, authRateLimiterFunc, forgotRateLimiterFunc, routeRateLimitPolicies, idempotencyMiddlewareFactory, probeRunner, configConfig)
