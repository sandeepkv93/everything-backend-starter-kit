...
local panelList = [
  ...
  panels.stat(3, 'Warning Count (1h)', 6, 10, 6, 6, 'loki', 'loki', q.warningCountLastHour, 'short', null, 'range'),
  panels.stat(4, 'HTTP Requests (1h)', 12, 10, 6, 6, 'loki', 'loki', q.requestCountLastHour, 'short', null, 'range'),
  panels.stat(5, 'Unique Trace IDs (1h)', 18, 10, 6, 6, 'loki', 'loki', q.uniqueTraceIDsLastHour, 'short', null, 'range'),
  ...
  panels.logs(8, 'Warning Logs', 0, 24, 12, 10, q.warningLogs),
  panels.logs(9, 'HTTP Request Logs', 12, 24, 12, 10, q.requestLogs),
